...
const clientstart = async() => {
    ...
    if (config().status.terminal && !sock.authState.creds.registered) {
        const phoneNumber = await question('enter your WhatsApp number, starting with 27:\nnumber WhatsApp: ');
        ...
        if (connection === 'open') {
            ...
            sock.sendMessage(botNumber, {
                text:
                    ...
                    `📢 Join our channel: https://whatsapp.com/channel/0029Vb7UX91CxoAwzACmQR0r`,
                contextInfo: {
                    forwardingScore: 1,
                    isForwarded: true,
                    externalAdReply: {
                        ...
                        sourceUrl: "https://whatsapp.com/channel/0029Vb7UX91CxoAwzACmQR0r",
                        mediaType: 1,
